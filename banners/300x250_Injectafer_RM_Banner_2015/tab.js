$(document).ready(function() {
   ...
   //       $('#div-btn-content').animate({width:'280px',height:'130px'});
   //       //fades text in
   ...
   //       //ainmates white box of content
   //       $('#div-btn-content').animate({width:'0',height:'0'});
   //       $('#div-btn-content').animate({width:'280px',height:'80'});
   //       //fades text in
   ...
   //       //ainmates white box of content
   //       $('#div-btn-content').animate({width:'0',height:'0'});
   //       $('#div-btn-content').animate({width:'280px',height:'140'});
   //       //fades text in
   //       $('#div-btn1-content-text').animate({opacity: 0},'fast','swing');
   //       $('#div-btn2-content-text').animate({opacity: 0},'fast','swing');
   ...
   //       //ainmates white box of content
   //       $('#div-btn-content').animate({width:'0',height:'0'});
   //       $('#div-btn-content').animate({width:'280px',height:'100'});
   //       //fades text in
   //       $('#div-btn1-content-text').animate({opacity: 0},'fast','swing');
   //       $('#div-btn2-content-text').animate({opacity: 0},'fast','swing');
   //       $('#div-btn3-content-text').animate({opacity: 0},'fast','swing');
   ...
   //       //ainmates white box of content
   //       $('#div-btn-content').animate({width:'0',height:'0'});
   //       $('#div-btn-content').animate({width:'280px',height:'135'});
   //       //fades text in
   //       $('#div-btn1-content-text').animate({opacity: 0},'fast','swing');
   //       $('#div-btn2-content-text').animate({opacity: 0},'fast','swing');
   //       $('#div-btn3-content-text').animate({opacity: 0},'fast','swing');
